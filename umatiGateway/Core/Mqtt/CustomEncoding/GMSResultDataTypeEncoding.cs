...
namespace umatiGateway.Core.Mqtt.CustomEncoding
{
    public class GMSResultDataTypeEncoding : ICustomEncoding
    {
        ...
        public JObject? decode(ExtensionObject eto)
        {
            ...
            switch (encoding)
            {
                case ExtensionObjectEncoding.Binary: return decodeBinary(eto);
        ...
        private JObject? decodeBinary(ExtensionObject eto)
        {
            ...
            try
            {
                ...
                int resultDataEncodingMask = binaryDecoder.ReadInt32("EncodingMask");
                bool hasResultContent = (resultDataEncodingMask >> 0 & 1) == 1;
                int encodingMask = binaryDecoder.ReadInt32("EncodingMask");
