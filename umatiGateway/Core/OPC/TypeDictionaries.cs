...
namespace umatiGateway.Core.OPC
{
    public class TypeDictionaries
    {
        ...
        public bool ReadExtraLibs = true;
        ...
        public TypeDictionaries(UmatiGatewayApp app)
        {
            this.app = app;
        }
        ...
        public void ReadOpcBinary()
        {
            ...
            if (ReadExtraLibs)
            {
                generateDataClasses(DI);
                generateDataClasses(Machinery_Jobs);
                generateDataClasses(JobControl);
            }
            List<NodeId> opcBinaryNodeIds = new List<NodeId>();
            ReadAndAppendTypeNodeIds(ObjectIds.OPCBinarySchema_TypeSystem, NodeClass.Variable, opcBinaryNodeIds, ReferenceTypeIds.HasComponent);
            ReadAndAppendTypeNodeIds(ObjectIds.OPCBinarySchema_TypeSystem, NodeClass.Variable, opcBinaryNodeIds, ReferenceTypeIds.HasProperty);
            ...
            SetOpcBinaryTypes(opcBinaryTypes);
        }
        ...
        private void generateDataClasses(string xmlString)
        {
                    ...
                    case XmlNodeType.Element:
                        ...
                        switch (nodeElement)
                        {
                            case "opc:StructuredType":
                                ...
                                {
                                    errorMemmory.Add("The Name of the structure is null");
                                }
                                break;
                            ...
                            case "opc:Field":
                                ...
                                {
                                    errorMemmory.Add("The TypeName of the Field is null");
                                }
                                ...
                                {
                                    errorMemmory.Add("The Name of the Field is null");
                                }
                                ...
                                if (length != null)
                                {
                                    ...
                                    generatedField.Length = uint.Parse(length);
                                }
                                ...
                                {
                                    errorMemmory.Add("Trying to add a field to a non Structure.");
                                }
                                break;
                            case "opc:EnumeratedType":
                                ...
                                {
                                    errorMemmory.Add("The Name of the enumeration is null");
                                }
                            ...
                            case "opc:EnumeratedValue":
                                ...
                                {
                                    errorMemmory.Add("The Name of the EnumeratedValue is null");
                                }
                                ...
                                {
                                    errorMemmory.Add("The Value of the EnumeratedValue is null");
                                }
                            ...
                            case "opc:TypeDictionary":
                                ...
                                {
                                    errorMemmory.Add("The TargetNameSpace for the Typedictionary is null.");
                                }
                        ...
                        switch (nodeElement)
                        {
                            case "opc:StructuredType":
                                if (targetNamespace != null)
                                {
                                    ...
                                    generatedDataTypes.Add(gdd, generatedStructure);
                                }
                                break;
                            case "opc:EnumeratedType":
                                if (targetNamespace != null)
                                {
                                    ...
                                    gdd.extraNameSpaces = extraNameSpaces;
                                    generatedStructure.DataTypeDefinition = gdd;
                                    generatedDataTypes.Add(gdd, generatedEnumeratedType);
                                }
                                break;
                        }
                        break;
            ...
            foreach (string error in errorMemmory)
            {
                Logger.Error(error);
            }
        }
        public void ReadDataTypes()
        {
            ...
            ReadAndAppendTypeNodeIds(DataTypeIds.BaseDataType, NodeClass.DataType, dataTypeNodeIds);
        ...
        public void ReadEventTypes()
        {
            ...
            ReadAndAppendTypeNodeIds(ObjectTypeIds.BaseEventType, NodeClass.ObjectType, eventTypeNodeIds);
        ...
        public void ReadInterfaceTypes()
        {
            ...
            ReadAndAppendTypeNodeIds(ObjectTypeIds.BaseInterfaceType, NodeClass.ObjectType, interfaceTypeNodeIds);
        ...
        public void ReadObjectTypes()
        {
            ...
            ReadAndAppendTypeNodeIds(ObjectTypeIds.BaseObjectType, NodeClass.ObjectType, objectTypeNodeIds);
        ...
        public void ReadReferenceTypes()
        {
            ...
            ReadAndAppendTypeNodeIds(ReferenceTypeIds.References, NodeClass.ReferenceType, referenceTypeNodeIds);
        ...
        public void ReadVariableTypes()
        {
            ...
            ReadAndAppendTypeNodeIds(VariableTypeIds.BaseVariableType, NodeClass.VariableType, variableTypeNodeIds);
